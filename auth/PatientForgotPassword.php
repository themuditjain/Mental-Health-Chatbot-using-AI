...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url(../Images/Website/PatientLogin.jpeg); */
            border: chartreuse;
        }
...
<body>
    ...
    <div class="box">
        <form action="PatientForgotPassword.php" method="post">
...
if (isset($_POST['register'])) {
    ...
    $query = "select * from patientregistration where patient_phone = '$phonenumber' and patient_pan = '$pan'";
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        if ($count_rows != 0) {
            $update_query = "update patientregistration set patient_password = '$encryption' 
                                    where patient_phone = '$phonenumber' and patient_pan = '$pan' ";
