...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../styles/patient_reg.css">
	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
					<div class="card-header" style="background: linear-gradient(#0E0220, #000729);"><h4 style="font-style:bold;color:goldenrod">Register</h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="PatientRegistration.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary"  style="background-color:#0E0220;color:goldenrod" name="register" value="Register">
										Register
									</button>
								</div>
							</form>
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		$query = "insert into patientregistration (patient_name,patient_phone,patient_addr,patient_bank,patient_pan,patient_mail,patient_username,patient_password) 
